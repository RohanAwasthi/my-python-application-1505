#!/bin/bash
mkdir s3
aws s3 cp s3://devex-deploy/python.zip /root/.jenkins/workspace/custom-actions/Sonarmy-python-application-1505/s3
unzip s3/python.zip -d /root/.jenkins/workspace/custom-actions/Sonarmy-python-application-1505/s3
cd s3
